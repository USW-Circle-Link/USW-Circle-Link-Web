...
export default {
  ...
  data() {
    return {
      ...
      fetchUrl: `https://api.donggurami.net/club-leader/${store.state.clubUUID}/applicants`, // 지원자 명단을 가져오는 서버 URL
      submitUrl: `https://api.donggurami.net/club-leader/${store.state.clubUUID}/applicants/notifications`, // 합/불 결과를 보내는 서버 URL
      show401Popup: false,
    };
  },
  //지원자 명단 가져오기
